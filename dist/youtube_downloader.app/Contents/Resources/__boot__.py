...
_site_packages('/media/james/alibaba2/FILES_OFFICE/chillout/codes/youtube_downloader', '/home/james/Documents/ProgramFiles/anaconda2', 0)
...
_path_inject(['/media/james/alibaba2/FILES_OFFICE/chillout/codes/youtube_downloader_app'])
...
DEFAULT_SCRIPT='/media/james/alibaba2/FILES_OFFICE/chillout/codes/youtube_downloader_app/youtube_downloader.py'
SCRIPT_MAP={}
try:
    _run()
